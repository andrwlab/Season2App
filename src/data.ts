...
export const teams = [
    { name: 'Equipo A', logo: '🅰️', color: 'team-card', players: 12 },
    { name: 'Equipo B', logo: '🅱️', color: 'team-card', players: 12 },
    { name: 'Equipo C', logo: '🅾️', color: 'team-card', players: 12 },
    { name: 'Equipo D', logo: '🆎', color: 'team-card', players: 12 },
  ];
